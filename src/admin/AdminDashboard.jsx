...
import { MdMovie, MdPeople, MdShoppingCart } from 'react-icons/md'; // Sử dụng các icon từ react-icons/md

const AdminDashboard = () => {
  return (
    <div className="grid grid-cols-1 mt-7 sm:grid-cols-2 lg:grid-cols-3 gap-6">
      <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-xl hover:bg-gray-50 transition-all duration-300 transform hover:scale-105">
